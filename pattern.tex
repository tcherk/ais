...
$r_e=e^2/(m_ec^2)$  классический радиус электрона = \textbf{2.81}79380\,$\cdot$\,10\textsuperscript{-15} м $\approx$ 2.82\,$\cdot$\,10\textsuperscript{-5} $\dot A$
...
$\mathbfit{\alpha}$ = $\frac{2\pi e^2}{hc}$ постоянная тонкой структуры = \textbf{7.29}73506\,$\cdot$\,10\textsuperscript{-3} = 1/137.03604 $\approx$ 1/137

$\mathbfit{a_0}$  первый Боровский радиус электрона = $r_e/\alpha^2$ = \textbf{5.29}17706 0.529
